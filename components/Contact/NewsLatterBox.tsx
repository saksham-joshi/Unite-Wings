          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                <stop stopColor={theme === "light" ? COLORS.PRIMARY : "#ffffff"} stopOpacity="0.62" />
                <stop offset="1" stopColor={theme === "light" ? COLORS.PRIMARY : "#ffffff"} stopOpacity="0" />
        ...
        <span className="absolute bottom-24 left-1.5">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? COLORS.PRIMARY : "#ffffff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
