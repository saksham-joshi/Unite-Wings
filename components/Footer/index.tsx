        ...
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2025 Unite Wings Educational Confederation. All Rights Reserved. | A Section 8 Company incorporated under the Companies Act, 2013
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor={COLORS.PRIMARY} stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
