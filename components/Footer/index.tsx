...
import { VALUES, COLORS, IMAGES } from "@/lib/variables";
    ...
    <>
      ...
      >
        <div className="container" align="center">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src={getImagePath(IMAGES.PATH.FULL_LOGO)}
                    alt="logo"
          ...
          <div className="py-8">
            <p className="text-center text-base text-xs text-body-color dark:text-white">
              © 2025 Unite Wings Educational Confederation. All Rights
              Reserved. | A Section 8 Company incorporated under the Companies
              Act, 2013
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor={COLORS.PRIMARY} stopOpacity="0.62" />
